...
public class GoingListAdapter extends RecyclerView.Adapter<GoingListAdapter.ViewHolder> {
    ...
    private GoingFragment mainActivity;

    public GoingListAdapter(List<HomeModel> data, GoingFragment mainActivity) {
        this.mData = data;
        this.mainActivity = mainActivity;
    }

    @Override
    public GoingListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        try {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public GoingFragment mainActivity;
        ...
        public ViewHolder(View itemLayoutView, GoingFragment mainActivity) {
