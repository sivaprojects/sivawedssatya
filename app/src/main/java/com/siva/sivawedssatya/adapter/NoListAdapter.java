...
public class NoListAdapter extends RecyclerView.Adapter<NoListAdapter.ViewHolder>{
    ...
    private NotGoingFragment mainActivity;

    public NoListAdapter(List<HomeModel> data, NotGoingFragment mainActivity) {
        this.mData = data;
        this.mainActivity = mainActivity;
    }

    @Override
    public NoListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        try {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public NotGoingFragment mainActivity;
        ...
        public ViewHolder(View itemLayoutView, NotGoingFragment mainActivity) {
